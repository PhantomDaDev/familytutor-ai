            ...
            with cols[index % 3]:
                ...
                st.markdown(
                    ...
                    <div class="profile-card">
                        ...
                        <div class="profile-name">{html.escape(child['name'])}</div>
                        <div class="profile-grade">Grade {child['grade']}</div>
                        <div class="profile-stats">
                            <span class="stat-pill">{streak.get('current_streak', 0)} day streak</span>
                            <span class="stat-pill">{streak.get('total_stars', 0)} stars</span>
